...
class Config:
    ...
    def __init__(self, env_file: Optional[str] = None):
        ...
        self.lcsc_api_url = os.getenv(
            "LCSC_API_URL", "https://api.lcsc.com/v1")
        self.lcsc_api_base_url = os.getenv(
        ...
        self.fuzzy_match_threshold = int(
            os.getenv("FUZZY_MATCH_THRESHOLD", "75"))
        self.default_match_threshold = float(
            os.getenv("DEFAULT_MATCH_THRESHOLD", "0.70"))
